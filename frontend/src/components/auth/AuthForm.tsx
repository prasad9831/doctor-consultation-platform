    ...
    <div className="w-full max-w-md mx-auto">
      ...
      <Card className="border-0 shadow-xl">
        <CardContent className="p-8">
          ...
          {error && (
            <div className="mb-4 p-3 bg-red-50 border border-red-50 rounded-md text-red-700 text-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {isSignup && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="border-0 border-b-2 border-gray-300 rounded-none focus:border-red-600 focus-visible:ring-0"
                  required
                />
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="border-0 border-b-2 border-gray-300 rounded-none focus:border-red-600 focus-visible:ring-0 pr-10"
                  required
                />
            ...
            {isSignup && (
              <div className="flex items-center space-x-2">
                ...
                >
                  I confirm that i am over 18 years old and agree to MediCare+{" "}
                  {""}
            ...
            <Button
              type="submit"
              className="w-full bg-red-600 hover:bg-red-700 rounded-full py-5"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 space-y-3">
              <Button
                type="button"
                variant="outline"
                className="w-full rounded-full border-gray-300 py-5"
