...
const PatientDashboardContent = () => {
  ...
  const { appointments, fetchAppointments, updateAppontmentStatus, loading } =
    useAppointmentStore();
          ...
          <div className="flex-shrink-0 flex justify-center md:justify-start">
            <Avatar className="w-20 h-20 border-2 border-white shadow-md">
              ...
              <AvatarFallback className="bg-gradient-to-br from-red-500 to-pink-500 text-white text-lg font-bold flex items-center justify-center">
                {getDoctorInitials(appointment.doctorId?.name)}
              </AvatarFallback>
            </Avatar>
          </div>
        ...
        <CardContent className="p-12 text-center">
          ...
          {state.showBookButton && (
            <Link href="/doctor-list">
              <Button>
                <Calendar className="w-4 h-4 mr-2" /> Book your first
                appointment
              </Button>
            </Link>
          )}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs md:text-lg text-gray-600">
                Manage your HealthCare appointment
              </p>
            </div>
